...
def main(cfg):
    ...
    for dataset in dataset_names:
        ...
        plt.savefig(
            os.path.join(cfg.out_dir, "PR_" + dataset + ".png"),
            dpi=600,
            bbox_inches="tight",
        )
        plt.close()
    ...
    for dataset in dataset_names:
        ...
        plt.legend(loc="lower left", prop={"size": 15})
        plt.savefig(
            os.path.join(cfg.out_dir, "Fm_" + dataset + ".png"),
            dpi=600,
            bbox_inches="tight",
        )
        plt.close()
    ...
    for dataset in dataset_names:
        ...
        plt.legend(loc="lower left", prop={"size": 15})
        plt.savefig(
            os.path.join(cfg.out_dir, "Em_" + dataset + ".png"),
            dpi=600,
            bbox_inches="tight",
        )
        plt.close()
    ...
    for dataset in dataset_names:
        ...
        plt.savefig(
            os.path.join(cfg.out_dir, "ROC_" + dataset + ".png"),
            dpi=600,
            bbox_inches="tight",
        )
        plt.close()
    ...
    for dataset in dataset_names:
        ...
        plt.savefig(
            os.path.join(cfg.out_dir, "Sm-MAE_" + dataset + ".png"), bbox_inches="tight"
        )
        plt.close()
